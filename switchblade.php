...
$botToken = "TOKEN"; #<5900466058:AAHrffB1U7K3lfgYFg-jFK_FBRyS-TRWH_g>#
...
// Proxy Configuration
$rp1 = array(
    1 => 'URPROXY',185.199.229.156
    2 => 'URPROXY',144.168.217.88
    3 => 'URPROXY',185.199.228.220
    4 => 'URPROXY',188.74.210.21
    5 => 'URPROXY',188.74.210.207
    ); 
    $rpt = array_rand($rp1);
    $rotate = $rp1[$rpt];
